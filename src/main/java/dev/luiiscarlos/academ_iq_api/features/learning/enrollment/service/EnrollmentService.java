...
public interface EnrollmentService {
     ...
     * @throws EnrollmentAlreadyExists if the user is already enrolled in the
     *                                 course
     */
     ...
     *
     * @param pageable the pageable options to the enrollments to be retrieved
     ...
     *                                     user
     */
    Page<EnrollmentResponse> getAll(Pageable pageable, long userId);
     ...
     */
    EnrollmentResponse patchState(long userId, long courseId, Map<String, Object> args);
